...
<!DOCTYPE html>
<html lang="en">
<!-- Pantalla donde se suben los reportes generados y se muestran los registros de los archivos subidos a la BD en una tabla   -->
<head>
...
<nav class="navbar bg-body-tertiary, navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="container">
        <div class="col-sm-12">
            <h2 style="text-align: center;">SUBIR ARCHIVOS DE REPORTE | COFEPRIS 2023</h2>
            <br>
    </div>
    </div>
    ...
    <br></br>
        <div class="d-grid gap-2 col-6 mx-auto">
            ...
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#agregar"> Agregar archvivo</button>
